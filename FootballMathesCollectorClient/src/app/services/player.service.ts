...
const baseUrl = 'https://infinite-island-13820.herokuapp.com/api/footballers';
...
export class PlayerService {
  ...
  findByClub(name: any): Observable<Player[]> {
    return this.http.get<Player[]>(`${baseUrl}?club=${name}`);
  }
}
